...
import avatarEx from '../assets/avatares.png'
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2  gap-28 items-center'>
      <main>
        ...
        <div className='nt-10 flex items-center gap-2'>
          <Image src={avatarEx} alt="exemplos de usuários" />
      ...
      <Image
        src={appPreviewImg} alt="Dois celulares exibindo o app mobile" 
        quality={100}
      />
    </div>
  )
